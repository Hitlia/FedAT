...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/results/fedAT_0104_test.txt')
    parser.add_argument('--model_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/checkpoints/fedAT_0104.pth')
