...
from solver_dspot import Solver
...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/results/fedAT_1119_dspot.txt')
    parser.add_argument('--model_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/checkpoints/fedAT_1109.pth')
    # parser.add_argument('--results_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/results/fedAT_POT01_0929.txt')
    # parser.add_argument('--model_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/checkpoints/fedAT_POT995_0927.pth')
    parser.add_argument('--anormly_ratio', type=float, default=0.5)
    parser.add_argument('--model_name', type=str, default='anomaly_transformer_freq', 
                        choices=['anomaly_transformer', 'anomaly_transformer_freq','COUTA','DCdetector','DIF', \
                            'NCAD','TranAD','TcnED','STEN'])
