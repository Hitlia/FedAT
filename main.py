...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/results/AT_1114_max_ad.txt')
    parser.add_argument('--model_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/checkpoints/AT_1114_max_ad.pth')
    ...
    parser.add_argument('--model_name', type=str, default='anomaly_transformer', 
