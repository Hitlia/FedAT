...
from .fed_layers import Encoder, Decoder, EncoderLayer, DecoderLayer, my_Layernorm, series_decomp, series_decomp_multi
from .autoCorrelation_fed import AutoCorrelationLayer
from model.FourierCorrelation import FourierBlock, FourierCrossAttention
from model.MultiWaveletCorrelation_FED import MultiWaveletCross, MultiWaveletTransform
...
class FEDFormer(nn.Module):
    ...
    def forward(self, x):
        ...
        enc_out, series = self.encoder(enc_out, attn_mask=None)
        # dec
