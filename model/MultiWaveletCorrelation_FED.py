...
from model.utils import get_filter
...
class MultiWaveletTransform(nn.Module):
    ...
    def __init__(self, window_size=256, ich=1, k=8, alpha=16, c=128,
                 nCZ=1, L=0, base='legendre', mask_flag=True, attention_dropout=0.1,output_attention=True):
    ...
    def forward(self, queries, keys, values, sigma=None, attn_mask=None):
