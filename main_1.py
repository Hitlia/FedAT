...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/results/NCAD_POT_1104.txt')
    parser.add_argument('--model_save_path', type=str, default='/home/lixinying/anomaly_transformer/code/checkpoints/NCAD_1104.pth')
    parser.add_argument('--anormly_ratio', type=float, default=0.5)
    parser.add_argument('--model_name', type=str, default='NCAD', 
